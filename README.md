...
- „JSON herunterladen“ lädt den gesamten Datenstand als formatiertes JSON auf den Rechner herunter.
...
1. **Browser-Speicher:** Beim Öffnen der Anwendung wird der lokal im Browser gespeicherte Stand geladen. Ist noch kein Stand vorhanden, wird die Standardvorlage initialisiert.
